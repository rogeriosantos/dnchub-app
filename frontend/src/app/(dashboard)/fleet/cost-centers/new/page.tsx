...
export default function NewCostCenterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push("/fleet/cost-centers");
    } catch (err) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">New Cost Center</h1>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter the information for the new cost center
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end gap-2">
              <Button variant="outline" type="button" asChild>
                <Link href="/fleet/cost-centers">Cancel</Link>
              </Button>
